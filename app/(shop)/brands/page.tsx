...
export default async function BrandsPage({ searchParams }: Props) {
  ...
  const brands = await articleService.getPublishedBrands({
    page,
    limit,
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gray-50">
      <div className="relative z-10">
        <BrandHero total={brands.total} search={params.search} />
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
          {brands.items.length > 0 ? (
            ...
            <div className="rounded-2xl sm:rounded-3xl border border-dashed border-gray-200 bg-white py-16 sm:py-24 text-center">
