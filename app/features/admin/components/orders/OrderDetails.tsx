...
import { ArrowRight, User, MapPin, Wallet, Settings } from "lucide-react";
    ...
    <div className="space-y-5 sm:space-y-8">
      ...
      <div className="flex flex-col gap-3 sm:gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="shrink-0">
          <InvoiceButton order={order} siteLogo={siteLogo} siteName={siteName} />
        </div>
      </div>
      ...
      <div className="grid gap-3 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="rounded-2xl sm:rounded-3xl border border-gray-100 bg-white p-4 sm:p-6 shadow-sm md:col-span-2 lg:col-span-1">
          <div className="mb-2.5 sm:mb-3 flex items-center gap-2">
            <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-lg sm:rounded-xl bg-pink-50 text-pink-500">
      ...
      <div className="rounded-2xl sm:rounded-3xl border border-gray-100 bg-white p-4 sm:p-6 shadow-sm">
        <div className="mb-3 sm:mb-4 flex items-center gap-2">
          ...
          <h3 className="text-sm sm:text-base font-bold text-gray-900">تغییر وضعیت سفارش</h3>
        </div>
